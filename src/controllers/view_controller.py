...
class ViewController:
    ...
    def __init__(self, controller, width=500, height=500, fps_cap=60):
        ...
        _ = self.debug_canvas.create_text(5, 5, fill="gray30", text=f"Debug",
    ...
    def refresh(self):
        ...
        if self.selected_robot is not None:
            _ = self.canvas.create_oval(self.selected_robot.pos[0] - self.selected_robot._radius,
    ...
    def display_selected_info(self):
        ...
        if self.selected_robot is not None:
            self.debug_text = self.debug_canvas.create_text(5, 25, fill="gray45", text=self.selected_robot,
                                                            anchor="nw", font="Arial 10")
        else:
